...
const SignUp = () => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <TouchableOpacity onPress={() => onRegister(username, password)} style={[styles.button, { backgroundColor: colors.primary }]}>
        <Text style={[styles.buttonText, { color: colors.buttext }]}>Sign Up</Text>
      </TouchableOpacity>
